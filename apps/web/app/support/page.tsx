...
export default function SupportPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <main className="pt-14 px-4 md:px-8 max-w-4xl mx-auto py-16">
        ...
        <section id="how-it-works" className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
              <div className="text-4xl font-bold text-[#F97316]/30 mb-4">01</div>
            ...
            <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
              <div className="text-4xl font-bold text-[#F97316]/30 mb-4">02</div>
            ...
            <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
              <div className="text-4xl font-bold text-[#F97316]/30 mb-4">03</div>
        ...
        <section id="contact" className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
              ...
              <a href="mailto:hello@openmic.delhi" className="text-[#F97316] text-sm hover:underline">
                hello@openmic.delhi
              </a>
            ...
            <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
              ...
              <a href="mailto:venues@openmic.delhi" className="text-[#F97316] text-sm hover:underline">
        ...
        <section className="mb-20">
          ...
          <div className="bg-zinc-900/50 rounded-xl p-5 border border-zinc-800/50 mb-3">
        ...
        <div className="text-center">
          <button
            ...
            className="bg-[#F97316] text-white font-bold px-8 py-3 rounded-xl hover:bg-[#EA6C00] transition-colors duration-200"
          >
            Back to Home
          </button>
        </div>
